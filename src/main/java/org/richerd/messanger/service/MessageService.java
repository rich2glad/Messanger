...
import org.richerd.messanger.exception.DatanotFoundException;
...
public class MessageService {
	...
	public MessageService(){
		messages.put(1L, new Message(1, "Hello World", "Richerd"));
		messages.put(2L, new Message(2, "Hello Jersey", "Richerd"));
	}
